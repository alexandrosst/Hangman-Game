# Hangman-Game
## Σύντομή Περιγραφή
<p align="justify">Το παιχνίδι αυτό δημιουργήθηκε ως μια εξαμηνιαία εργασία στο πλαίσιο του μαθήματος "Τεχνολογία Πολυμέσων" του 7ου εξαμήνου. Το project αποτελεί μια ελαφρώς παραλλαγμένη εκδοχή του γνωστού παιχνιδιού της κρεμάλας.
Περιληπτικά, το παιχνίδι έχει την εξής μορφή:</p>
<ul>
...
![1](https://github.com/alexandrosst/Hangman-Game/assets/80393550/9b230493-6db8-454e-8753-eccb952e3f36)

![2](https://github.com/alexandrosst/Hangman-Game/assets/80393550/62a95f38-030d-41ab-b03d-bed0c40f2025)

![3](https://github.com/alexandrosst/Hangman-Game/assets/80393550/14a07f91-333f-4b3c-be24-839b081e846b)

![4](https://github.com/alexandrosst/Hangman-Game/assets/80393550/fcef466e-7eb3-4833-93bb-fc023e7ef681)
...
## Απαιτήσεις
Η εφαρμογή υλοποιήθηκε με τις ακόλουθες απαιτήσεις:
<ul>
	<li>Windows 10/11</li>
	<li>Java 17.0.1</li>
	<li>JavaFX 17.0.1</li>
