...
<ul>
	<li><p align="justify">Ο χρήστης επιλέγει το url κάποιου βιβλίου από το <href a="https://openlibrary.org/">Open Library</href>. Η εφαρμογή πραγματοποιεί ένα request στο API του Open Library, απ' όπου επιστρέφεται ως reply η περιγραφή του βιβλίου. Από την περιγραφή αυτή δημιουργείται ένα λεξικό λέξεων, το οποίο ο χρήστης μπορεί να καταστήσει ενεργό, προκειμένου ν' αντληθούν λέξεις απ' αυτό.</p></li>
