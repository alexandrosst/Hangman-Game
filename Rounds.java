...
/**
* Represents a round. Each round is described by a target word, the number of efforts made by user and a winner.
...
public class Rounds {
  ...
  /**
  * Creates a new {@link Rounds} record. Array of records is updated accordingly at the same time so as to having an array with exactly 5 records.
  ...
  */
  public Rounds(String Word, int Efforts, String Winner) {
    ...
    if (rounds.size() == 5) rounds.remove(0);
    rounds.add(this);
  }
